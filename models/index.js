...
//     phoneNum: { type: String, unique: true, required: true },
    email: { type: String, required: [true, "이메일은 필수 입력값입니다."], unique: true,
      trim: true, lowercase: true,},
    password: { type: String, required: true, minlength: [6, "비밀번호는 최소 6자 이상이어야 합니다."] },
